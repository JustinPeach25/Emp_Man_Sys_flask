create table admin(id integer AUTO_INCREMENT PRIMARY key, name text not null, surname text not null, password text not null, admin bool not null default 'O');
